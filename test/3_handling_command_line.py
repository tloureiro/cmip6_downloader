...
print(urlencode(url_params_dictionary))
print(search_params_dictionary)

# python3 test/3_handling_command_line.py --variable_id siflswdtop --experiment_id ssp126
# should generate
# https://esgf-node.llnl.gov/esg-search/search/?experiment_id=ssp126&variable_id=siflswdtop&offset=0&limit=9999&type=Dataset&replica=false&latest=true&project=CMIP6&format=application%2Fsolr%2Bjson